...
> *level* either: loudness / onset salience is not part of the audio path (planned
> for the 1.1 line, but neither 1.1.1 nor 1.1.2 shipped it), and no result on this
> site depends on it.
